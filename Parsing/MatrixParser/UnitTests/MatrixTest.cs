...
namespace MatrixParserProject.UnitTests
{
    public class MatrixTest
    {
        ...
        {
            var sut = new MatrixParser("1 2 3\n4 5 6\n7 8 9\n8 7 6");
        ...
        {
            var sut = new MatrixParser("89 1903 3\n18 3 1\n9 4 800");
