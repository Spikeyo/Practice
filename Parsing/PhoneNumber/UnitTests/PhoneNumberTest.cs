...
namespace PhoneNumberProject.UnitTests
{
    public class PhoneNumberTest
    {
        ...
        public void Cleans_the_number()
        {
            ...
            Assert.Equal("2234567890", PhoneNumberCleaner.Clean(phrase));
        }
        ...
        public void Invalid_when_9_digits()
        {
            ...
            Assert.Throws<ArgumentException>(() => PhoneNumberCleaner.Clean(phrase));
        }
