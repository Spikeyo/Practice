...
namespace ComplexNumbersProject.UnitTests
{
    public class ComplexNumbersTest
    {
        ...
        public void Subtract_purely_real_numbers()
        {
            var sut = new ComplexNumber(1, 0);
            var expected = new ComplexNumber(-1, 0);
            Assert.Equal(expected.Real, sut.Subtract(new ComplexNumber(2, 0)).Real, precision: 7);
            Assert.Equal(expected.Imaginary, sut.Subtract(new ComplexNumber(2, 0)).Imaginary, precision: 7);
        }
        ...
        public void Subtract_purely_imaginary_numbers()
        {
            ...
            Assert.Equal(expected.Real, sut.Subtract(new ComplexNumber(0, 2)).Real, precision: 7);
            Assert.Equal(expected.Imaginary, sut.Subtract(new ComplexNumber(0, 2)).Imaginary, precision: 7);
        }
        ...
        public void Subtract_numbers_with_real_and_imaginary_part()
        {
            ...
            Assert.Equal(expected.Real, sut.Subtract(new ComplexNumber(3, 4)).Real, precision: 7);
            Assert.Equal(expected.Imaginary, sut.Subtract(new ComplexNumber(3, 4)).Imaginary, precision: 7);
        }

        [Fact]
        public void Multiplytiply_purely_real_numbers()
        {
            var sut = new ComplexNumber(1, 0);
            var expected = new ComplexNumber(2, 0);
            Assert.Equal(expected.Real, sut.Multiply(new ComplexNumber(2, 0)).Real, precision: 7);
            Assert.Equal(expected.Imaginary, sut.Multiply(new ComplexNumber(2, 0)).Imaginary, precision: 7);
        }
        ...
        public void Divide_purely_real_numbers()
        {
            ...
            Assert.Equal(expected.Real, sut.DivideBy(new ComplexNumber(2, 0)).Real, precision: 7);
            Assert.Equal(expected.Imaginary, sut.DivideBy(new ComplexNumber(2, 0)).Imaginary, precision: 7);
        }
        ...
        public void Divide_purely_imaginary_numbers()
        {
            var sut = new ComplexNumber(0, 1);
            var expected = new ComplexNumber(0.5, 0);
            Assert.Equal(expected.Real, sut.DivideBy(new ComplexNumber(0, 2)).Real, precision: 7);
            Assert.Equal(expected.Imaginary, sut.DivideBy(new ComplexNumber(0, 2)).Imaginary, precision: 7);
        }
        ...
        public void Divide_numbers_with_real_and_imaginary_part()
        {
            ...
            Assert.Equal(expected.Real, sut.DivideBy(new ComplexNumber(3, 4)).Real, precision: 7);
            Assert.Equal(expected.Imaginary, sut.DivideBy(new ComplexNumber(3, 4)).Imaginary, precision: 7);
        }
        ...
        [Fact]
        public void Eulers_identity_forMultiplya()
        {
